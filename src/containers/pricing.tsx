...
export const Pricing = () => (
  <section
    id="pricing"
    className="flex h-full w-full flex-col bg-gradient-to-b from-fuchsia-900 to-rose-950 py-14 md:py-24"
  >
    <div className="container mx-auto">
      <div className="container mx-auto mt-8 px-28">
        ...
        <div className="h-min-fit flex w-full flex-col items-center justify-center gap-16 pt-20 text-left md:flex-row">
          <Card className="flex w-96 flex-col rounded-md border border-white bg-[#ead9e624] duration-100 ease-linear hover:scale-105 hover:shadow-2xl ">
            <CardHeader>
              <CardTitle>
