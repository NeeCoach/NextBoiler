...
export const FAQ = () => (
  <section
    id="faq"
    className="z-50 flex min-h-fit w-full flex-col bg-gradient-to-b from-rose-950 to-fuchsia-900 py-14 text-white max-md:px-4 md:px-14 md:py-24"
  >
    ...
    <div className="mb-20 rounded-md border border-white bg-[#ead9e624] py-4 backdrop-blur-[25px] max-md:px-4 md:px-8 md:py-14">
