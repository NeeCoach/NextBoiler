...
function page() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-b from-rose-950 to-fuchsia-900 p-0 py-32">
      <div className="flex flex-col m-4 px-2 z-40 rounded-md border border-white bg-[#ead9e624] py-4 backdrop-blur-[25px] max-md:px-4 md:px-2 justify-center items-center md:mx-36 shadow-xl">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-8 ">
          {galleryJson.map((item, index) => (
            <GlassyCard
              ...
              className="shadow-md border-2 border-solid border-white rounded-md"
              id="1"
              key={index}
              {...item}
            />
