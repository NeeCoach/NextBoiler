...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Swap faces in images with advanced AI technology.
      </span>
    ),
    header: <SkeletonOne />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Create realistic deepfake videos using AI.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  {
    title: "AI Social Media Descriptions",
    description: (
      <span className="text-sm">
        Generate engaging social media descriptions with AI.
      </span>
    ),
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">Create high-resolution images with AI.</span>
    ),
    header: <SkeletonFour />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Convert your media into multiple formats using AI.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
